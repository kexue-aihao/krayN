...
internal static class CoreConfigTestFactory
{
    ...
    public static ProfileItem CreateKrayNode(string indexId = "node-kray-1", string remarks = "demo-kray")
    {
        var node = new ProfileItem
        {
            IndexId = indexId,
            ...
            Port = 8443,
            Username = "client-1",
            Password = "ZmFrZS1jbGllbnQtc2VjcmV0LWZha2UtY2xpZW50LXNlY3JldA",
            PublicKey = "ZmFrZS1zZXJ2ZXItcHVibGljLWtleS1mYWtlLXNlcnZlci1wdWJsaWMta2V5",
            Network = "websocket",
            Sni = "edge.example",
