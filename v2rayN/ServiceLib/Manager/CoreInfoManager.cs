...
public sealed class CoreInfoManager
{
    ...
    private void InitCoreInfo()
    {
        ...
        var urlKray = GetCoreUrl(ECoreType.kray);
        ...
        [
            new CoreInfo
                ...
                new CoreInfo
                {
                    ...
                    CoreExes = ["krayn-core"],
                    Arguments = "{0}",
                    Url = GetCoreUrl(ECoreType.kray),
                    ReleaseApiUrl = urlKray.Replace(Global.GithubUrl, Global.GithubApiUrl),
                    DownloadUrlWin64 = urlKray + "/download/{0}/krayn-core-windows-amd64.exe",
                    DownloadUrlWinArm64 = urlKray + "/download/{0}/krayn-core-windows-arm64.exe",
                    DownloadUrlLinux64 = urlKray + "/download/{0}/krayn-core-linux-amd64",
                    DownloadUrlLinuxArm64 = urlKray + "/download/{0}/krayn-core-linux-arm64",
                    DownloadUrlOSX64 = urlKray + "/download/{0}/krayn-core-darwin-amd64",
                    DownloadUrlOSXArm64 = urlKray + "/download/{0}/krayn-core-darwin-arm64",
                    Match = "krayn-core",
                    VersionArg = "-version",
                },
