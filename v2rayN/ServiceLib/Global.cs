...
public class Global
{
    ...
    public const string AppName = "krayN";
    ...
    public const string AutoRunName = "krayNAutoRun";
    ...
    public const string AvaAssets = "avares://krayN/Assets/";
    public const string LocalAppData = "KRAYN_LOCAL_APPLICATION_DATA";
    ...
    public const string KrayProtocolShare = "kray://";
